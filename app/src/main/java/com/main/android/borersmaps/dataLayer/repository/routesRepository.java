...
public class routesRepository {
    ...
    public List<routeEntity> getRoutesByStopId(String id, sqlLiteDatabaseHelper myDbHelper){
        ...
        Cursor c = db.rawQuery("select distinct(routeEntities._id), routeEntities.route_name from routes_stops  inner join routeEntities on routeEntities._id=routes_stops.route_id where stop_id="+id, null);
